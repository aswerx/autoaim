...
local MainBOX = GeneralTab:AddLeftTabbox("Ana Menü") do
    ...
    Main:Add("aim_Enabled", {Text = "Enabled"}):AddKeyPicker("aim_Enabled_KeyPicker", {Default = "RightAlt", SyncToggleState = true, Mode = "Toggle", Text = "Enabled", NoUI = false});
...
local FieldOfViewBOX = GeneralTab:AddLeftTabbox("Field Of View") do
    ...
    Main:AddSlider("Radius", {Text = "FOV Circle Radius", Min = 0, Max = 360, Default = 37, Rounding = 0}):OnChanged(function()
